        ...
        <div class="container">
            ...
            <form class="form-group  w-75" action="{{url('buscar/')}}" method="GET">
                    <div class="input-group">
                        <input class="form-control form-control-lg border-left-0 border " type="search" placeholder="Buscar produto" id="buscar" name="buscar" value="{{$nome}}">
...
@section('main')
    ...
    <div class="container">
        ...
        <h2 class="mb-0 text-dark">{{$nome}}</h2>
        ...
        <div class="row ">
            ...
            @else
                <div class="card col-3 bg-light mb-3">
                    <div class="card-body">
                        <a class="card-link" href="{{url('produto')}}/{{$produto->id}}">
